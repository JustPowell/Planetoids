...
struct Simplex
{
	...
	Simplex() : grad3({ { glm::vec3(1, 1, 0), glm::vec3(-1, 1, 0), glm::vec3(1, -1, 0), glm::vec3(-1, -1, 0),
		glm::vec3(1, 0, 1), glm::vec3(-1, 0, 1), glm::vec3(1, 0, -1), glm::vec3(-1, 0, -1),
		glm::vec3(0, 1, 1), glm::vec3(0, -1, 1), glm::vec3(0, 1, -1), glm::vec3(0, -1, -1) } }), p({ { 151, 160, 137, 91, 90, 15,
	...
	double sdot(glm::vec3 g, double x, double y, double z);
